...
![crontab -e Command](assets/crontab-e.png)
...
![crontab -l Command](assets/crontab-l.png)

##### crontab -r
ผู้ใช้สามารถลบ cronjob ทั้งหมดได้ด้วยคำสั่งดังต่อไปนี้

![crontab -r Command](assets/crontab-r.png)
...
![atq Command](assets/atq.png) ![at -r Command](assets/at-r.png)
